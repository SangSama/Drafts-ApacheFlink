...
// run: ./bin/flink run ../../Udemy/study-apache-flink/iterate/target/iterate-flink-1.0-SNAPSHOT.jar
...
public class IterateDemo {
    public static void main(String[] args) throws Exception {
        ...
        equaltoten.writeAsText("/mnt/d/FSS/ApacheFlink/Udemy/study-apache-flink/data/s03/output/iteration_ten");
