...
// run: ./bin/flink run ../../Udemy/study-apache-flink/reduce/target/reduce-flink-1.0-SNAPSHOT.jar
...
public class AverageProfit {
    public static void main(String[] args) throws Exception {
        ...
        DataStream < String > data = env.readTextFile("/mnt/d/FSS/ApacheFlink/Udemy/study-apache-flink/data/s03/reduce/avg");
        ...
        profitPerMonth.writeAsText("/mnt/d/FSS/ApacheFlink/Udemy/study-apache-flink/data/s03/output/profit_per_month.txt");
